...
// Parse configuration
var databaseUri = "mongodb://nername:Bravas2018@ds237641.mlab.com:37641/heroku_vd0v5czc";//process.env.DATABASE_URI || process.env.MONGOLAB_URI;
var serverUrl = process.env.SERVER_URL || 'http://localhost:1337/parse';
var appId = process.env.APP_ID || '31nKoJemcC';
var masterKey = process.env.MASTER_KEY || '3U28SQTW8B';
var restApiKey = 'NnwJuGvRJ0';
var appName = 'nearme';

// Mailgun configuration
var apiKey = process.env.MAILGUN_API_KEY || '7024b7744d56a2e44d43cad6cd265e75-8889127d-373ec4a7';
var domain = process.env.MAILGUN_DOMAIN || 'sandbox2d3d4d53c7944362b70612e41a2049a8.mailgun.org';
